...
function updateCinemaSubtitleGap(settings){
  var preview=document.querySelector('.settings-subtitle-preview'),a=document.getElementById('subtitlePreviewPrimary'),b=document.getElementById('subtitlePreviewSecondary');
...
function cinemaSubtitleLayerDefaults(name){return JSON.parse(JSON.stringify(DEFAULT_SUBTITLE_SETTINGS[name]))}
  ...
  function initSettingsAccordions() {
    ...
    page.querySelectorAll('.settings-card').forEach(function(card) {
